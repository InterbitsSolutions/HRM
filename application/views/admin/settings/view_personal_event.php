                        ...
                        <form role="form" id="form" action="<?php echo base_url(); ?>admin/settings/save_event/<?php if (!empty($event_info)) echo $event_info->event_id; ?> " method="post" class="form-horizontal form-groups-bordered">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-5">
                                    <input type="text"  class="form-control datepicker" id="start_date_event" name="start_date" value="<?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-5">
                                    <input type="text" class="form-control datepicker" id="end_date_event" name="end_date" value="<?php
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-5 pull-right">
                                    <button type="submit" class="btn btn-primary" id="submit"><?php echo $this->language->from_body()[1][12] ?></button>
                                </div>
                            </div>
                        </form>
                    </div>
